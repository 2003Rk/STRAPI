...
export interface ApiLearningContentLearningContent
  ...
  info: {
    description: 'Learning content for the real estate platform';
    displayName: 'Learning Content';
    pluralName: 'learning-contents';
    singularName: 'learning-content';
  };
  options: {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::learning-content.learning-content'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiPostPost extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    Pricesquantities: Schema.Attribute.Integer;
